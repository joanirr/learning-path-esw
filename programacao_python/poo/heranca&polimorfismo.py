...
class Jacare(Animal, Nadador):
    ...
    def mover(self):
        return f"{self.andar()}, {self.nadar()}"
...
print(fazer_som(jacare))    # Saída: Roooor!
...
print(fazer_movimento(jacare))    # Saída: Jacare wesley está andando, Jacare Wesley está nadando.